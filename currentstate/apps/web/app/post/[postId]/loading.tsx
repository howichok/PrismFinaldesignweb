    ...
    <main className="py-12 md:py-16">
      <Container className="space-y-8">
        ...
        <div className="space-y-4">
          <div className="h-10 w-2/3 animate-pulse rounded-2xl bg-[color:var(--color-line)]" />
          <div className="flex flex-wrap gap-3">
            <div className="h-4 w-36 animate-pulse rounded-full bg-[color:var(--color-line)]" />
            <div className="h-4 w-40 animate-pulse rounded-full bg-[color:var(--color-line)]" />
        ...
        <Card className="space-y-3">
          ...
          <div className="h-4 w-10/12 animate-pulse rounded-full bg-[color:var(--color-line)]" />
        </Card>
      </Container>
    </main>
  );
