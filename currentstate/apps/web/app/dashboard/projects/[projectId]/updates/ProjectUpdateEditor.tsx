...
export default function ProjectUpdateEditor({
  mode,
  projectId,
  updateId,
  ...
  const fetchUpdate = useCallback(async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(getErrorMessage(data, "Update not found."));
      }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!response.ok || !data.item) {
        throw new Error(getErrorMessage(data, "Unable to save update."));
      }
